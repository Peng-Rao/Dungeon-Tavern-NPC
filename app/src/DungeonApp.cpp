...
protected:
  ...
  void localInit() {
    DSLlocal.init(this, {
                            ...
                            {1, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                             VK_SHADER_STAGE_FRAGMENT_BIT, 0, 4}, // albedo[4]
                            {2, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                             VK_SHADER_STAGE_FRAGMENT_BIT, 4, 4}, // normal[4]
                            {3, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                             VK_SHADER_STAGE_FRAGMENT_BIT, 8, 4}, // metallic[4]
                            {4, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                             VK_SHADER_STAGE_FRAGMENT_BIT, 12, 4}, // roughness[4]
                            {5, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                             VK_SHADER_STAGE_FRAGMENT_BIT, 16, 4} // ao[4]
                        });
    ...
    DSLglobal.init(this, {
                             ...
                             {1, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                              VK_SHADER_STAGE_FRAGMENT_BIT, 0, 1}, // irrMap (samplerCube)
                             {2, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER,
                              VK_SHADER_STAGE_FRAGMENT_BIT, 0, 1} // envMap (samplerCube)
                         });
    ...
    P.init(this, &VD, "shaders/mesh/MeshTBN.vert.spv", "shaders/ibl/IBLExercise.frag.spv",
           {&DSLglobal, &DSLlocal});

    PSkybox.init(this, &VDskybox, "shaders/skybox/SkyboxExercise.vert.spv",
                 "shaders/skybox/SkyboxExercise.frag.spv", {&DSLskybox});
    ...
    TNorm[0].init(this, "assets/textures/materials/ice-field/ice_field_normal-ogl.png",
                  VK_FORMAT_R8G8B8A8_UNORM);
    Tmetal[0].init(this, "assets/textures/materials/ice-field/ice_field_metallic.png",
                   VK_FORMAT_R8G8B8A8_UNORM);
    Troughness[0].init(this, "assets/textures/materials/ice-field/ice_field_roughness.png",
                       VK_FORMAT_R8G8B8A8_UNORM);
    Tao[0].init(this, "assets/textures/materials/ice-field/ice_field_ao.png",
                VK_FORMAT_R8G8B8A8_UNORM);

    Talbedo[1].init(this, "assets/textures/materials/rock-wall-mortar/rock-wall-mortar_albedo.png");
    TNorm[1].init(this,
                  "assets/textures/materials/rock-wall-mortar/rock-wall-mortar_normal-ogl.png",
                  VK_FORMAT_R8G8B8A8_UNORM);
    Tmetal[1].init(this, "assets/textures/materials/rock-wall-mortar/rock-wall-mortar_metallic.png",
                   VK_FORMAT_R8G8B8A8_UNORM);
    Troughness[1].init(this,
                       "assets/textures/materials/rock-wall-mortar/rock-wall-mortar_roughness.png",
                       VK_FORMAT_R8G8B8A8_UNORM);
    Tao[1].init(this, "assets/textures/materials/rock-wall-mortar/rock-wall-mortar_ao.png",
                VK_FORMAT_R8G8B8A8_UNORM);

    Talbedo[2].init(this, "assets/textures/materials/granite-tile/granite-tile_albedo.png");
    TNorm[2].init(this, "assets/textures/materials/granite-tile/granite-tile_normal-ogl.png",
                  VK_FORMAT_R8G8B8A8_UNORM);
    Tmetal[2].init(this, "assets/textures/materials/granite-tile/granite-tile_metallic.png",
                   VK_FORMAT_R8G8B8A8_UNORM);
    Troughness[2].init(this, "assets/textures/materials/granite-tile/granite-tile_roughness.png",
                       VK_FORMAT_R8G8B8A8_UNORM);
    Tao[2].init(this, "assets/textures/materials/granite-tile/granite-tile_ao.png",
                VK_FORMAT_R8G8B8A8_UNORM);

    Talbedo[3].init(this, "assets/textures/materials/clay-shingles1/clay-shingles1_albedo.png");
    TNorm[3].init(this, "assets/textures/materials/clay-shingles1/clay-shingles1_normal-ogl.png",
                  VK_FORMAT_R8G8B8A8_UNORM);
    Tmetal[3].init(this, "assets/textures/materials/clay-shingles1/clay-shingles1_metallic.png",
                   VK_FORMAT_R8G8B8A8_UNORM);
    Troughness[3].init(this,
                       "assets/textures/materials/clay-shingles1/clay-shingles1_roughness.png",
                       VK_FORMAT_R8G8B8A8_UNORM);
    Tao[3].init(this, "assets/textures/materials/clay-shingles1/clay-shingles1_ao.png",
                VK_FORMAT_R8G8B8A8_UNORM);
  ...
  void pipelinesAndDescriptorSetsInit() {
    ...
    DSglobal.init(this, &DSLglobal, {TirrMap.getViewAndSampler(), TenvMap.getViewAndSampler()});
  ...
  void updateUniformBuffer(uint32_t currentImage) {
    ...
    ubo.mMat = glm::translate(glm::mat4(1), glm::vec3(3, 0, -5)) *
               glm::scale(glm::mat4(1), glm::vec3(5.22f));
    ubo.mvpMat = ViewPrj * ubo.mMat;
    ubo.nMat = glm::inverse(glm::transpose(ubo.mMat));
